...
public abstract class Evaluator {
	...
	public static final float addNodeRate = 0.07f;
...
//		}
	...
	public void afterRound(){
		...
		// System.out.println(topGenome.getFitness() + " " +
		// species.get(0).bestGenome().getFitness());
		...
		while (nextGenomes.size() <= popSize) {
			counter++;
			// System.out.println(species.size() +" size " + counter);
